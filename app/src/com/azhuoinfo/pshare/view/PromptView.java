...
public class PromptView extends LinearLayout {
	...
	public void showPrompt(int action,String str){
		Drawable topIcon=this.getResources().getDrawable(R.drawable.ic_image_error);
	...
	public void showEmpty(){
		showPrompt(ACTION_NOTHING,R.string.common_empty);
	}
	
	public void showError(){
		showPrompt(ACTION_NOTHING,R.string.common_error);
	}
	
	public void showNoLogin(){
		showPrompt(ACTION_LOGIN,R.string.common_nologin);
	}
	
	public void showRetry(){
		Drawable topIcon=this.getResources().getDrawable(R.drawable.ic_image_refresh);
		showPrompt(ACTION_RETRY,R.string.common_retry,topIcon);
	}
	public void showRetry(int resId){
		Drawable topIcon=this.getResources().getDrawable(R.drawable.ic_image_refresh);
		showPrompt(ACTION_RETRY,resId,topIcon);
	}
	public void showRetry(String str){
		Drawable topIcon=this.getResources().getDrawable(R.drawable.ic_image_refresh);
		showPrompt(ACTION_RETRY,str,topIcon);
	}
